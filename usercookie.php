<?php
	...
	setcookie($cookie_name, $info, time() + (86400/24)*3, "/"); 
	//this places the cookie on their computer... note that time() equals the current time so the cookie expires after three hours
...
<body>
	<?php	
		if(!isset($_COOKIE[$cookie_name])) {
			...
			echo "Welcome " . $info[0];
			echo "<br><a href="profilepage.php">Click Here to<br>Continue to<br>Profile page</a>";
			...
			// this is necessary to let people know that they need to have cookies enabled to use our website.
		}
	?>
